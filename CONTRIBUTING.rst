...
- While logged into your GitHub account, navigate to the
  ``python-pubsublite`` `repo`_ on GitHub.

- Fork and clone the ``python-pubsublite`` repository to your GitHub account by
  clicking the "Fork" button.

- Clone your fork of ``python-pubsublite`` from your GitHub account to your local
  computer, substituting your account username and specifying the destination
  as ``hack-on-python-pubsublite``.  E.g.::

   $ cd ${HOME}
   $ git clone git@github.com:USERNAME/python-pubsublite.git hack-on-python-pubsublite
   $ cd hack-on-python-pubsublite
   # Configure remotes such that you can pull changes from the googleapis/python-pubsublite
   # repository into your local repository.
   $ git remote add upstream git@github.com:googleapis/python-pubsublite.git
...
.. _repo: https://github.com/googleapis/python-pubsublite
...
- In order to make ``nox -s lint`` run faster, you can set some environment
  ...
  version of ``python-pubsublite``. The
