...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "false"}):
        assert CursorServiceClient._read_environment_variables() == (
            False,
            "auto",
            None,
        )
...
def test__get_client_cert_source():
    ...
    assert (
        CursorServiceClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        CursorServiceClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                CursorServiceClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                CursorServiceClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(CursorServiceClient),
)
@mock.patch.object(
    CursorServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(CursorServiceAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = CursorServiceClient._DEFAULT_UNIVERSE
    default_endpoint = CursorServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = CursorServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        CursorServiceClient._get_api_endpoint(
    ...
    assert (
        ...
        == CursorServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        CursorServiceClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        CursorServiceClient._get_api_endpoint(None, None, default_universe, "always")
        == CursorServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        CursorServiceClient._get_api_endpoint(
    ...
    assert (
        CursorServiceClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        CursorServiceClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        CursorServiceClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        CursorServiceClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        CursorServiceClient._get_universe_domain(None, None)
        == CursorServiceClient._DEFAULT_UNIVERSE
    )
...
def test_cursor_service_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
@mock.patch.object(
    CursorServiceClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(CursorServiceClient),
)
@mock.patch.object(
    CursorServiceAsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(CursorServiceAsyncClient),
)
...
def test_cursor_service_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_streaming_commit_cursor(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(
        type(client.transport.streaming_commit_cursor), "__call__"
    ) as call:
...
def test_streaming_commit_cursor_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert (
            client._transport.streaming_commit_cursor
...
@pytest.mark.asyncio
async def test_streaming_commit_cursor_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.streaming_commit_cursor
...
@pytest.mark.asyncio
async def test_streaming_commit_cursor_async(
...
@pytest.mark.asyncio
async def test_commit_cursor_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.commit_cursor
            in client._client._transport._wrapped_methods
        )
...
def test_list_partition_cursors_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.list_partition_cursors
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_list_partition_cursors_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_partition_cursors
            in client._client._transport._wrapped_methods
        )
...
def test_cursor_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.pubsublite_v1.services.cursor_service.transports.CursorServiceTransport.__init__"
    ) as Transport:
...
def test_cursor_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.pubsublite_v1.services.cursor_service.transports.CursorServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
def test_cursor_service_transport_channel_mtls_with_client_cert_source(transport_class):
    with mock.patch(
...
def test_cursor_service_transport_channel_mtls_with_adc(transport_class):
    mock_ssl_cred = mock.Mock()
