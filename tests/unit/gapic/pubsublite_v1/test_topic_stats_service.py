...
def test__read_environment_variables():
    assert TopicStatsServiceClient._read_environment_variables() == (
        False,
        "auto",
        None,
    )
...
def test__get_client_cert_source():
    ...
    assert (
        TopicStatsServiceClient._get_client_cert_source(
            mock_provided_cert_source, False
        )
        is None
    )
    assert (
        TopicStatsServiceClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                TopicStatsServiceClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(TopicStatsServiceClient),
)
@mock.patch.object(
    TopicStatsServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(TopicStatsServiceAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = TopicStatsServiceClient._DEFAULT_UNIVERSE
    default_endpoint = TopicStatsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = TopicStatsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        TopicStatsServiceClient._get_api_endpoint(
    ...
    assert (
        ...
        == TopicStatsServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        TopicStatsServiceClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        TopicStatsServiceClient._get_api_endpoint(
    ...
    assert (
        TopicStatsServiceClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        TopicStatsServiceClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        TopicStatsServiceClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        TopicStatsServiceClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        TopicStatsServiceClient._get_universe_domain(None, None)
        == TopicStatsServiceClient._DEFAULT_UNIVERSE
    )
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = TopicStatsServiceClient(credentials=cred)
...
def test_topic_stats_service_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_topic_stats_service_client_from_service_account_file(
    client_class, transport_name
):
    creds = ga_credentials.AnonymousCredentials()
    with mock.patch.object(
...
def test_topic_stats_service_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_compute_message_stats_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert (
            client._transport.compute_message_stats
...
@pytest.mark.asyncio
async def test_compute_message_stats_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.compute_message_stats
...
def test_compute_head_cursor_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = TopicStatsServiceClient(
        ...
        # Ensure method has been cached
        assert (
            client._transport.compute_head_cursor in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[
            client._transport.compute_head_cursor
        ] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_compute_head_cursor_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.compute_head_cursor
            in client._client._transport._wrapped_methods
        )
...
def test_compute_time_cursor_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = TopicStatsServiceClient(
        ...
        # Ensure method has been cached
        assert (
            client._transport.compute_time_cursor in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[
            client._transport.compute_time_cursor
        ] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_compute_time_cursor_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.compute_time_cursor
            in client._client._transport._wrapped_methods
        )
...
def test_compute_message_stats_empty_call_grpc():
    client = TopicStatsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
        ...
        call.return_value = topic_stats.ComputeMessageStatsResponse()
        client.compute_message_stats(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = topic_stats.ComputeMessageStatsRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_compute_head_cursor_empty_call_grpc():
    client = TopicStatsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
        ...
        call.return_value = topic_stats.ComputeHeadCursorResponse()
        client.compute_head_cursor(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = topic_stats.ComputeHeadCursorRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_compute_time_cursor_empty_call_grpc():
    client = TopicStatsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
        ...
        call.return_value = topic_stats.ComputeTimeCursorResponse()
        client.compute_time_cursor(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = topic_stats.ComputeTimeCursorRequest()

        assert args[0] == request_msg


def test_transport_kind_grpc_asyncio():
    transport = TopicStatsServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_compute_message_stats_empty_call_grpc_asyncio():
    client = TopicStatsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(
        ...
        await client.compute_message_stats(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_compute_head_cursor_empty_call_grpc_asyncio():
    client = TopicStatsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.compute_head_cursor(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_compute_time_cursor_empty_call_grpc_asyncio():
    client = TopicStatsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.compute_time_cursor(request=None)
