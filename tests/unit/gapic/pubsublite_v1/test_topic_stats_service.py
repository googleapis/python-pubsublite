...
from google.cloud.pubsublite_v1.services.topic_stats_service.transports.base import (
...
def test_topic_stats_service_client_service_account_always_use_jwt(client_class):
    with mock.patch.object(
...
def test_topic_stats_service_client_service_account_always_use_jwt_true(
    transport_class, transport_name
):
    with mock.patch.object(
        service_account.Credentials, "with_always_use_jwt_access", create=True
