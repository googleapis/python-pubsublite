...
from google.cloud.pubsublite_v1.services.partition_assignment_service.transports.base import (
...
def test_partition_assignment_service_client_service_account_always_use_jwt_true(
    transport_class, transport_name
):
    with mock.patch.object(
        service_account.Credentials, "with_always_use_jwt_access", create=True
...
@requires_google_auth_lt_1_25_0
def test_partition_assignment_service_transport_auth_adc_old_google_auth(
    transport_class,
):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
