...
class CursorServiceGrpcAsyncIOTransport(CursorServiceTransport):
    ...
    def streaming_commit_cursor(
        ...
        if "streaming_commit_cursor" not in self._stubs:
            self._stubs["streaming_commit_cursor"] = self._logged_channel.stream_stream(
    ...
    def commit_cursor(
        ...
        if "commit_cursor" not in self._stubs:
            self._stubs["commit_cursor"] = self._logged_channel.unary_unary(
    ...
    def list_partition_cursors(
        ...
        if "list_partition_cursors" not in self._stubs:
            self._stubs["list_partition_cursors"] = self._logged_channel.unary_unary(
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.streaming_commit_cursor: self._wrap_method(
                self.streaming_commit_cursor,
                default_timeout=None,
                client_info=client_info,
            ),
            self.commit_cursor: self._wrap_method(
                self.commit_cursor,
            ...
            self.list_partition_cursors: self._wrap_method(
