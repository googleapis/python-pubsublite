...
class CursorServiceClient(metaclass=CursorServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        transport: Union[str, CursorServiceTransport] = None,
    ...
    def streaming_commit_cursor(
        ...
        *,
        ...
        rpc = gapic_v1.method.wrap_method(
            self._transport.streaming_commit_cursor,
    ...
    def list_partition_cursors(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = gapic_v1.method.wrap_method(
            self._transport.list_partition_cursors,
            default_timeout=None,
            client_info=_client_info,
        )
