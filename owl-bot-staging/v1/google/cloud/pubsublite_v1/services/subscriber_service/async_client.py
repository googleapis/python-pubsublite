...
class SubscriberServiceAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = SubscriberServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    get_transport_class = SubscriberServiceClient.get_transport_class

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, SubscriberServiceTransport, Callable[..., SubscriberServiceTransport]]] = "grpc_asyncio",
            client_options: Optional[ClientOptions] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the subscriber service async client.
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.pubsublite_v1.SubscriberServiceAsyncClient`.",
                extra = {
    ...
    def subscribe(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.subscribe]
