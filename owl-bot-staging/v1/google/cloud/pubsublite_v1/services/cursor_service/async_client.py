...
class CursorServiceAsyncClient:
    ...
    get_transport_class = CursorServiceClient.get_transport_class

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, CursorServiceTransport, Callable[..., CursorServiceTransport]]] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.pubsublite_v1.CursorServiceAsyncClient`.",
                extra = {
    ...
    def streaming_commit_cursor(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.streaming_commit_cursor]
    ...
    async def commit_cursor(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.commit_cursor]
    ...
    async def list_partition_cursors(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_partition_cursors]
