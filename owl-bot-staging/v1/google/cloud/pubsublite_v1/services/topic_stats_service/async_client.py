...
class TopicStatsServiceAsyncClient:
    ...
    get_transport_class = TopicStatsServiceClient.get_transport_class

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, TopicStatsServiceTransport, Callable[..., TopicStatsServiceTransport]]] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.pubsublite_v1.TopicStatsServiceAsyncClient`.",
                extra = {
    ...
    async def compute_message_stats(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.compute_message_stats]
    ...
    async def compute_head_cursor(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.compute_head_cursor]
    ...
    async def compute_time_cursor(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.compute_time_cursor]
